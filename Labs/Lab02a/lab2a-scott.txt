...
select p.productid, p.productname, p.unitprice, p.unitsinstock from products p where unitsinstock > 0 order by unitprice desc limit 5;
...
count (c.customerID)
92
select count (s.supplierID) from suppliers s;
count (s.supplierID)
29
